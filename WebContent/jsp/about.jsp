    ...
    <div class="after-sale w1200">
      ...
      <div class="item-box">
        <div class="item item1">
          <div class="img-box">
            <img src="${ pageContext.request.contextPath }/res/static/img/us_icon1.png">
          </div>
          <p>7天无理由退换货</p>
        </div>
        <div class="item item2">
          <div class="img-box">
            <img src="${ pageContext.request.contextPath }/res/static/img/us_icon2.png">
          </div>
          <p>全场满99元顺丰包邮</p>
        </div>
        <div class="item item3">
          <div class="img-box">
            <img src="${ pageContext.request.contextPath }/res/static/img/us_icon3.png">
          </div>
          <p>优质客服服务</p>
        </div>
      </div>
