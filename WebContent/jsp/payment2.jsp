...
<%@ include file="head.jsp" %>
  <div class="content content-nav-base shopcart-content">
    ...
    <div class="cart w1200">
      ...
      <img id="QRCode" style="display: block;margin: auto;width: 20%;" alt="付款" src='${ pageContext.request.contextPath }/QRCode2.pay?pieces=${ pieces }'>
    	<a href="${ pageContext.request.contextPath }/OrderAdd2.odo">
